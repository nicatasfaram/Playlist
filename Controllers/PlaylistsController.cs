...
namespace Playlist.Controllers
{
    public class PlaylistsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PlaylistId,Name")] Playlist.Models.Playlist playlist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PlaylistId,Name")] Playlist.Models.Playlist playlist)
        {
